...
class DolgozoSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('dolgozos')->insert([
            ...
            ['neve' => 'Szabó Anna', 'szuldatum' => '1981-05-02', 'cim' => 'Érd', 'telefonszam' => '06200231196', 'email' => 'sza@gmail.com', 'munkakor_id' => 2, 'jelszo' => bcrypt('jelszo')],
            ...
            ['neve' => 'Kovács Lilla', 'szuldatum' => '2001-05-19', 'cim' => 'Pécs', 'telefonszam' => '06300239996', 'email' => 'kl@gmail.com', 'munkakor_id' => 2, 'jelszo' => bcrypt('jelszo')],
